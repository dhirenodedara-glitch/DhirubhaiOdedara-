...
function ClassicTabLayout() {
  ...
  return (
    ...
    >
      ...
      />
      <Tabs.Screen name="coach" options={{ title: 'Coach', tabBarIcon: ({ color }) => <Feather name="message-circle" size={22} color={color} /> }} />
      <Tabs.Screen name="challenges" options={{ title: 'Challenges', tabBarIcon: ({ color }) => <Feather name="flag" size={22} color={color} /> }} />
      <Tabs.Screen name="progress" options={{ title: 'Progress', tabBarIcon: ({ color }) => <Feather name="bar-chart-2" size={22} color={color} /> }} />
